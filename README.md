...
Excel – pivot tables, formulas, and data validation
Process Improvement – Lean Six Sigma Yellow Belt
📂 Projects (In Progress)
Beginner_SQL_Project → sample queries from training datasets
Data_Cleaning_Practice → working with messy CSV/Excel files
First_Python_Analysis → small analysis/visualization in Jupyter Notebook
🎓 Education & Certifications
B.S. in Data Analytics (in progress) – Southern New Hampshire University (SNHU)
